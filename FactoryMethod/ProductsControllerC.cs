...
namespace FactoryMethod
{
    ...
    public class ProductsControllerC:FactoryMethod.Solution.Sharp.SharpController
    {
        public void ListProducts()
        {
            ...
            //call render method from the base to return the html using sharp framework
