// real example, we need to store out application config in a class and use it on all
// places we need just one single copy of this class
...
configManagerSingle.Set("firstname", "Mohmed");
configManagerSingle.Set("lastname", "Ahmed");
Console.WriteLine(configManagerSingle.Get("firstname"));

ConfigManagerSingle configManagerSingle2 = ConfigManagerSingle.GetInstance;
Console.WriteLine(configManagerSingle2.Get("firstname")); //return the same result as it refere to the same instnace
